...
% Element is not the reason, as it is not an inner class of the
% factory but of the companion object, which means it just has
% an additional dot in its name as Ring.Element instead of RingElem
% but is in any other respect independent of the factory.
