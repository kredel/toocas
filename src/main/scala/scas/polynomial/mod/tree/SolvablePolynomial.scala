...
class SolvablePolynomial[@specialized(Int, Long) N](mod: java.math.BigInteger, val pp: PowerProduct[N])(implicit val ordering: Ordering[N]) extends scas.polynomial.SolvablePolynomial[SolvablePolynomial[N], ModInteger, N] with TreePolynomial[SolvablePolynomial[N], N] {
