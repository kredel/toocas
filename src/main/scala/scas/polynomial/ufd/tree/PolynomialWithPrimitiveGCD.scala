...
object PolynomialWithPrimitiveGCD {
  ...
  class Element[C, @specialized(Int, Long) N](val value: SortedMap[Array[N], C])(override val factory: PolynomialWithPrimitiveGCD[C, N]) extends PolynomialOverUFD.Element[Element[C, N], C, N] with TreePolynomial.Element[Element[C, N], C, N]
