...
object PolynomialWithSubresGCD {
  ...
  class Element[C, @specialized(Int, Long) N](val value: SortedMap[Array[N], C])(override val factory: PolynomialWithSubresGCD[C, N]) extends scas.polynomial.ufd.PolynomialOverUFD.Element[Element[C, N], C, N] with TreePolynomial.Element[Element[C, N], C, N]
