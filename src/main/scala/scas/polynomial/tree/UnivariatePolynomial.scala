...
object UnivariatePolynomial {
  ...
  class Element[C, @specialized(Int, Long) N](val value: SortedMap[Array[N], C], val element: Module_Element[Polynomial.Element[C, N]])(val factory: UnivariatePolynomial[C, N]) extends TreePolynomial.Element[Element[C, N], C, N] with scas.polynomial.UnivariatePolynomialWithSyzygy.Element[Polynomial.Element, Element[C, N], C, N]
