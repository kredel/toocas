...
class UnivariatePolynomial[C, @specialized(Int, Long) N](val ring: Field[C], val pp: PowerProduct[N], val module: Module[Polynomial.Element[C, N], C, N])(implicit val cm: ClassManifest[Element[C, N]]) extends TreePolynomial[Element[C, N], C, N] with scas.polynomial.UnivariatePolynomial[Polynomial.Element, Element[C, N], C, N] {
...
object UnivariatePolynomial {
  ...
  class Element[C, @specialized(Int, Long) N](val value: SortedMap[Array[N], C], val element: Module_Element[Polynomial.Element[C, N]])(val factory: UnivariatePolynomial[C, N]) extends TreePolynomial.Element[Element[C, N], C, N] with scas.polynomial.UnivariatePolynomial.Element[Polynomial.Element, Element[C, N], C, N]
